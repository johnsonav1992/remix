import type { AnyParams, ContextEntries, Middleware, RequestContext, RouterTypes } from '@remix-run/fetch-router';
type RequestContextWithAnyParams<context> = context extends RequestContext<any, infer entries extends ContextEntries> ? RequestContext<AnyParams, entries> : RequestContext<AnyParams>;
