...
type RequireAuthContextTransform<identity> = <context extends RequestContext<any, any>>(context: context) => ContextWithEntry<context, readonly [typeof Auth, ResolvedGoodAuth<context, identity>]>;
/**
