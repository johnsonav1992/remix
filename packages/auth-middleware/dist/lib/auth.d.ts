 ...
 */
export declare function auth<schemes extends readonly AuthScheme<any>[]>(options: AuthOptions<schemes>): Middleware<readonly [typeof Auth, AuthForSchemes<schemes>]>;
export {};
