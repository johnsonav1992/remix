...
] ? [key] extends [last[0]] ? [last[0]] extends [key] ? last[1] : ResolveEntryValue<rest, key, fallback> : ResolveEntryValue<rest, key, fallback> : fallback;
/**
 ...
 */
export type ContextWithEntries<context, additions extends ContextEntries> = context extends RequestContext<infer params extends Record<string, any>, infer entries extends ContextEntries> ? RequestContext<params, [...entries, ...additions]> : never;
/**
 * Replaces or adds the value type for a single context entry in a {@link RequestContext}.
 * This is useful when deriving a context shape without a middleware tuple.
 */
export type ContextWithEntry<context, entry extends readonly [object, unknown]> = ContextWithEntries<context, [entry]>;
/**
