...
import type { ContextEntries, ContextWithEntries, ContextWithEntry, RequestContext } from './request-context.ts';
/**
 * A middleware of any context transform.
 */
export type AnyMiddleware = Middleware<ContextTransform>;
type ContextTransform = readonly [object, unknown] | ContextEntries | (<context extends RequestContext<any, any>>(context: context) => RequestContext<any, any>);
...
type ContextWithTransform<context extends RequestContext<any, any>, transform> = transform extends ContextEntries ? ContextWithEntries<context, transform> : transform extends readonly [object, unknown] ? ContextWithEntry<context, transform> : transform extends {
